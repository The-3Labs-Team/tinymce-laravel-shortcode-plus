...
function parseIndex(content) {
    ...
    content = content.replace(indexRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #ffa500; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseReadMore(content) {
    ...
    content = content.replace(readMoreRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #00a0ff; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseTrivia(content) {
    ...
    content = content.replace(triviaRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #c912eb; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseSurvey(content) {
    ...
    content = content.replace(surveyRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #4bc444; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseFacebook(content) {
    ...
    content = content.replace(facebookRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #3b5998; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseInstagram(content) {
    ...
    content = content.replace(instagramRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style = "display:inline-block; border-radius: 10px; border: 2px dashed #d62976; font-size: 14px; width: 100%;" >
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseTwitter(content) {
    ...
    content = content.replace(twitterRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #14171A; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseBlueSky(content) {
    ...
    content = content.replace(blueSkyRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style = "display:inline-block; border-radius: 10px; border: 2px dashed #0085FF; font-size: 14px; width: 100%;" >
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseReddit(content) {
    ...
    content = content.replace(redditRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style = "display:inline-block; border-radius: 10px; border: 2px dashed #FF4500; font-size: 14px; width: 100%;" >
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseYoutube(content) {
    ...
    content = content.replace(youtubeRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style = "display:inline-block; border-radius: 10px; border: 2px dashed #cc181e; font-size: 14px; width: 100%;" >
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseTiktok(content) {
    ...
    content = content.replace(tiktokRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style = "display:inline-block; border-radius: 10px; border: 2px dashed #fe2858; font-size: 14px; width: 100%;" >
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseSpotify(content) {
    ...
    content = content.replace(spotifyRegex, function (match) {
        ...
        const html = `<small class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #1db954; font-size: 14px; width: 100%;">
            <small style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
