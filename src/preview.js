...
function parseTrivia(content) {
    ...
    content = content.replace(triviaRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #c912eb; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseFacebook(content) {
    ...
    content = content.replace(facebookRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #3b5998; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseInstagram(content) {
    ...
    content = content.replace(instagramRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #d62976; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseTwitter(content) {
    ...
    content = content.replace(twitterRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #14171A; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseBlueSky(content) {
    ...
    content = content.replace(blueSkyRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #0085FF; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseReddit(content) {
    ...
    content = content.replace(redditRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #FF4500; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseYoutube(content) {
    ...
    content = content.replace(youtubeRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #cc181e; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
...
function parseTiktok(content) {
    ...
    content = content.replace(tiktokRegex, function (match) {
        ...
        const html = `<span class="shortcode-preview" style="display:inline-block; border-radius: 10px; border: 2px dashed #fe2858; font-size: 14px; width: 80%;">
        <span style="display: block; text-align: center; font-weight: 500; color: #969696; padding: 50px 10px;">
